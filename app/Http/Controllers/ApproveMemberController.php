...
class ApproveMemberController extends Controller
{
    ...
    public function __construct(Member $member)
    {
        ...
        $this->baseModel = $member;
        $this->defaultRole = 'children';
        $this->paramid = 'mbr';
        $this->paramrole = 'famrole';
        $this->hdninput = '_fmid';
        $this->title = array('header' => 'Override Membership Status', 'singular' => 'Member');
    ...
    {   
        ...
        return view('members.index', 
            ['title' => $this->title, 'results' => $results, 'tableCols' => $tableCols, 'urls' => $urls, 'dlt_field' => $this->hdninput, 'dlt_act' => 'deleteFamily', 'editbutton' => 'Edit Membership']
        );
    }
    ...
    {   
        ...
        return view('membership.edit', 
            ['title' => $title, 'tableCols' => $tableCols, 'urls' => $urls, 'member' => $fellowship, 'info' => $info, 'validRoles' => $this->validRoles, 'order' => $validRoles, 'default_role' => $this->defaultRole, 'dlt_field' => $this->hdninput]
        );
    }
